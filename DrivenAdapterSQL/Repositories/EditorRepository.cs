...
namespace DrivenAdapterSQL.Repositories
{
    public class EditorRepository : IEditorRepository
    {
        ...
        public async Task<Editor> InsertEditorAsync(Editor editor)
        {
            ...
            string sqlQuery = $"INSERT INTO {tableName} (id_editor, id_user, complete_name,phone,estate)VALUES(@id, @idUser, @completeName, @phoneM,@estateE)";
